...
export default async function CustomersPage() {
    ...
    return (
        <div className="flex justify-center items-center max-w-full mx-auto mt-4 border p-4 rounded-lg shadow-md">
            <Table>
                    ...
                    <TableRow key={customer.id}>
                        ...
                        <TableCell>{customer.name}</TableCell>
                            <TableCell>{customer.address}</TableCell>
                              <TableCell><a href={`/customers/${customer.id}`}>View Details</a></TableCell>
                    </TableRow>
                    ))}
                </TableBody>
                <TableFooter>
